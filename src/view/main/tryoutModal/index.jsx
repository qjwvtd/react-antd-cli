...
import ProgressPage from '../progressPage/index.jsx';
import { setCurrentProjectId, setCurrentUserType } from '@/common/store/storage/index.js';
...
class MyForm extends Component{
    ...
    getTryOutData(){
        // 超时处理 20s
        let url = 'api/enterprise/v1/user/create/probation/data';
        axios.get(url, {
            params: {
                _t: +(new Date())
            },
